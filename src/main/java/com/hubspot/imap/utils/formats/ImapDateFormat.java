...
public class ImapDateFormat {
  ...
  private static final DateTimeFormatter IMAP_SHORT_DATE_FORMAT =
    new DateTimeFormatterBuilder().appendPattern("dd-MMM-yyyy ").toFormatter(Locale.US);

  public static final DateTimeFormatter INTERNALDATE_FORMATTER =
    DateTimeFormatter.ofPattern("d-MMM-yyyy HH:mm:ss Z");
  private static final DateTimeFormatter INTERNALDATE_FORMATTER_WITH_ZONE =
    DateTimeFormatter.ofPattern("d-MMM-yyyy HH:mm:ss Z z");
